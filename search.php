...
*/
	...
	$layout_id = 0;
	$page_settings = va_page_settings("products_advanced_search", $layout_id);
	...
	if (is_array($page_settings)) {
		foreach ($page_settings as $setting_name => $setting_value)
		{
			...
			} elseif ($setting_name == "products_advanced_search") {
				include_once("./blocks/block_products_search_advanced.php");
				products_search_advanced_form($setting_value);
	...
	$html_title = get_translation(get_setting_value($page_settings, "html_title", ADVANCED_SEARCH_TITLE));
