...
*/
	...
	$layout_id = 0;
	$page_settings = va_page_settings("reset_password", $layout_id);

	$t = new VA_Template($settings["templates_dir"]);
	$t->set_file("main", "reset_password.html");
	...
	if (is_array($page_settings)) {
		foreach ($page_settings as $setting_name => $setting_value)
		{
			...
			} elseif ($setting_name == "reset_password") {
				include_once("./blocks/block_password_reset.php");
				password_reset_form($setting_value);
