...
*/
	...
	$layout_id = 0;
	$page_settings = va_page_settings("wishlist", $layout_id);

	$t = new VA_Template($settings["templates_dir"]);
	$t->set_file("main", "wishlist.html");
	...
	$html_title = get_translation(get_setting_value($settings, "index_title", "Wishlist"));
