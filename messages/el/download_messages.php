...
*/
	...
	// download messages
	define("DOWNLOAD_WRONG_PARAM", "Λάθος παράμετροι στην μεταφόρτωση");
	define("DOWNLOAD_MISS_PARAM", "Λείπουν παράμετροι για την μεταφόρτωση");
	define("DOWNLOAD_INACTIVE", "Η μεταφόρτωση δεν είναι ενεργή");
	define("DOWNLOAD_EXPIRED", "Έχει λήξει η περίοδος για να γίνει η μεταφόρτωση");
	define("DOWNLOAD_LIMITED", "Έχετε ξεπεράσει τον μεγαλύτερο αριθμό μεταφορτώσεων");
	define("DOWNLOAD_PATH_ERROR", "Η πορεία προς το προϊόν δεν μπορεί να βρεθεί");
	define("DOWNLOAD_RELEASE_ERROR", "τίποτα σχετικό δεν μπορεί να βρεθεί");
	define("DOWNLOAD_USER_ERROR", "Μόνο εγγεγραμμένοι χρήστες μπορούν να κάνουν μεταφόρτωση");
	...
	define("UPLOAD_SELECT_MSG", "Επιλέξτε το αρχείο που θέλετε να ανεβάσετε και πατήστε στο {button_name}");
	define("UPLOADED_FILE_MSG", "Το αρχείο <b>{filename}</b> Έχει ανέβει.");
	define("UPLOAD_SELECT_ERROR", "Παρακαλώ επιλέξτε πρώτα το αρχείο");
	define("UPLOAD_IMAGE_ERROR", "Μόνο εικόνες επιτρέπονται");
	define("UPLOAD_FORMAT_ERROR", "This type of file is not allowed.");
	define("UPLOAD_SIZE_ERROR", "Αρχεία μεγαλύτερα από {filesize} δεν είναι δυνατόν να ανέβουν.");
	define("UPLOAD_DIMENSION_ERROR", "Οι εικόνες μεγαλύτερες από {dimension} δεν επιτρέπονται");
	define("UPLOAD_CREATE_ERROR", "Το σύστημα δεν μπορεί να δημιουργήσει αυτό το αρχείο");
	define("UPLOAD_ACCESS_ERROR", "You don't have permissions to upload files.");
	define("DELETE_FILE_CONFIRM_MSG", "Are you sure you want delete this file?");
