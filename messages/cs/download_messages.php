...
*/
	...
	// download messages
	define("DOWNLOAD_WRONG_PARAM", "Nesprávný download parameter.");
	define("DOWNLOAD_MISS_PARAM", "Chybìjící download parametr.");
	define("DOWNLOAD_INACTIVE", "Stáhnutí neaktívní.");
	define("DOWNLOAD_EXPIRED", "Váš èas na stáhnutí vypršel.");
	define("DOWNLOAD_LIMITED", "Pøekroèili jste maximální poèet možných stáhnutí.");
	define("DOWNLOAD_PATH_ERROR", "Nemùžu nájít cestu k produktu.");
	define("DOWNLOAD_RELEASE_ERROR", "Vydání nenalezeno");
	define("DOWNLOAD_USER_ERROR", "Jenom registrovaní uživatelé mùžou stáhnout tenhle soubor");
	...
	define("UPLOAD_SELECT_MSG", "Vyberte soubor pro nahrání a stisknìte tlaèítko {button_name} .");
	define("UPLOADED_FILE_MSG", "Soubor <b>{filename}</b> byl nahraný.");
	define("UPLOAD_SELECT_ERROR", "Prosím nejdøív vyberte nìjaký soubor.");
	define("UPLOAD_IMAGE_ERROR", "Jsou povoleny jenom soubory typu obrázek.");
	define("UPLOAD_FORMAT_ERROR", "This type of file is not allowed.");
	define("UPLOAD_SIZE_ERROR", "Soubory vìtší než {filesize} nejsou dovolené.");
	define("UPLOAD_DIMENSION_ERROR", "Soubory rozmìrù vìtších než {dimension} nejsou dovolené.");
	define("UPLOAD_CREATE_ERROR", "Systém nemùže vytvoøit soubor.");
