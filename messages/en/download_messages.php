...
*/
	...
	// download messages
	define("DOWNLOAD_WRONG_PARAM", "Wrong download parameter(s).");
	define("DOWNLOAD_MISS_PARAM", "Missing download parameter(s).");
	define("DOWNLOAD_INACTIVE", "Download inactive.");
	define("DOWNLOAD_EXPIRED", "Your download period has expired.");
	define("DOWNLOAD_LIMITED", "You have exceed the maximum number of downloads.");
	define("DOWNLOAD_PATH_ERROR", "Path to product cannot be found.");
	define("DOWNLOAD_RELEASE_ERROR", "Release wasn't found.");
	define("DOWNLOAD_USER_ERROR", "Only registered users can download this file.");
	...
	define("UPLOAD_SELECT_MSG", "Select file to upload and press {button_name} button.");
	define("UPLOADED_FILE_MSG", "File <b>{filename}</b> was uploaded.");
	define("UPLOAD_SELECT_ERROR", "Please select a file first.");
	define("UPLOAD_IMAGE_ERROR", "Only image files are allowed.");
	define("UPLOAD_FORMAT_ERROR", "This type of file is not allowed.");
	define("UPLOAD_SIZE_ERROR", "Files bigger than {filesize} are not allowed.");
	define("UPLOAD_DIMENSION_ERROR", "Images larger than {dimension} are not allowed.");
	define("UPLOAD_CREATE_ERROR", "System can't create the file.");
