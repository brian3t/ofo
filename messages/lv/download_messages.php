...
*/
	...
	// download messages
	define("DOWNLOAD_WRONG_PARAM", "Nepareizi lejupielâdes parametri.");
	define("DOWNLOAD_MISS_PARAM", "Trûkst lejupielâdes parametri");
	define("DOWNLOAD_INACTIVE", "Lejupielâde nav aktîva.");
	define("DOWNLOAD_EXPIRED", "Jûsu lejupielâdes laiks/periods ir beidzies.");
	define("DOWNLOAD_LIMITED", "Jûs esat iztçrçjuði maksimâlo lejupielâdes skaitu");
	define("DOWNLOAD_PATH_ERROR", "Ceïð lîdz produktam nav atrodams.");
	define("DOWNLOAD_RELEASE_ERROR", "Izdevums nav atrasts");
	define("DOWNLOAD_USER_ERROR", "Ðo failu var lejupielâdçt tikai reìistrçti lietotâji.");
	...
	define("UPLOAD_SELECT_MSG", "Izvçlieties failu, kuru vçlaties augðupielâdçt un spiediet {button_name} pogu.");
	define("UPLOADED_FILE_MSG", "Fails <b>{filename}</b> tika augðupielâdçts.");
	define("UPLOAD_SELECT_ERROR", "Lûdzu, vispirms izvçlieties failu.");
	define("UPLOAD_IMAGE_ERROR", "Tikai attçla faili ir atïauti.");
	define("UPLOAD_FORMAT_ERROR", "This type of file is not allowed.");
	define("UPLOAD_SIZE_ERROR", "Faili lielâki par {filesize} nav atïauti.");
	define("UPLOAD_DIMENSION_ERROR", "Bildes lielâkas par {dimension} nav atïautas.");
	define("UPLOAD_CREATE_ERROR", "Sistçma nevar izveidot failu.");
