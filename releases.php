...
*/
	...
	$current_page = "releases.php";
	$tax_rates = get_tax_rates();

	$layout_id = 0;
	$page_settings = va_page_settings("products_releases", $layout_id);

	$t = new VA_Template($settings["templates_dir"]);
	$t->set_file("main", "releases.html");
	...
	$html_title = get_translation(get_setting_value($page_settings, "html_title", RELEASES_TITLE));
