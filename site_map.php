...
*/
	...
	$layout_id = 0;
	$page_settings = va_page_settings("site_map", $layout_id);
	$current_page  = get_custom_friendly_url("site_map.php");
	
	$t = new VA_Template($settings["templates_dir"]);
	$t->set_file("main", "site_map.html");
	...
	$index_title = get_translation(get_setting_value($settings, "index_title", SITE_MAP_TITLE));
