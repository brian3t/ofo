...
/*
 * DGL EUDEBIT (2000charge.com) transaction handler by www.viart.com
 */
	...
	$post_params = str_replace('&UserAgent=user_agent', '&UserAgent='.urlencode($_SERVER['HTTP_USER_AGENT']), $post_params);
