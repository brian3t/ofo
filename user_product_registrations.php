...
*/
	...
	$current_page = "user_product_registrations.php";
	...
	if (is_array($page_settings)) {
		foreach ($page_settings as $setting_name => $setting_value)
		{
			if ($setting_name == "userhome_breadcrumb") {
				...
				include_once("./blocks/block_user_product_registrations.php");
	...
	$html_title = get_translation(get_setting_value($page_settings, "html_title", MY_PRODUCT_REGISTRATIONS_MSG));
