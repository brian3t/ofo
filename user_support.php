...
*/
	...
	if (is_array($page_settings)) {
		foreach ($page_settings as $setting_name => $setting_value)
		{
			if ($setting_name == "userhome_breadcrumb") {
				...
				include_once("./blocks/block_user_support.php");
	...
	$html_title = get_translation(get_setting_value($page_settings, "html_title", MY_SUPPORT_ISSUES_MSG));
