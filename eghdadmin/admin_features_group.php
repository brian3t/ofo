...
*/
  ...
  $t->set_file("main","admin_features_group.html");
	...
	$t->set_var("CONFIRM_DELETE_JS", str_replace("{record_name}", GROUP_MSG, CONFIRM_DELETE_MSG));
	...
	$r = new VA_Record($table_prefix . "features_groups");
	$r->return_page = "admin_features_groups.php";
