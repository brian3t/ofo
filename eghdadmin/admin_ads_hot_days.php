...
*/
  ...
  $t->set_file("main","admin_ads_hot_days.html");
	...
	$s = new VA_Sorter($settings["admin_templates_dir"], "sorter_img.html", "admin_ads_hot_days.php");
	...
	$n = new VA_Navigator($settings["admin_templates_dir"], "navigator.html", "admin_ads_hot_days.php");

	include_once("./admin_header.php");
	include_once("./admin_footer.php");

	// set up variables for navigator
	$db->query("SELECT COUNT(*) FROM " . $table_prefix . "ads_hot_days");
	$db->next_record();
	...
	$db->query("SELECT * FROM " . $table_prefix . "ads_hot_days" . $s->order_by);
	if($db->next_record())
	{
