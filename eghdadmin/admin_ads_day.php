...
*/
  ...
  $t->set_file("main","admin_ads_day.html");

	$t->set_var("admin_href",           "admin.php");
	$t->set_var("admin_ads_href",       "admin_ads.php");
	$t->set_var("admin_ads_days_href", "admin_ads_days.php");
	$t->set_var("admin_ads_day_href",  "admin_ads_day.php");

	$r = new VA_Record($table_prefix . "ads_days");
	$r->return_page = "admin_ads_days.php";
