...
/*
  ...
  ***                                                                      ***
  ***      ViArt Shop 3.6                                                  ***
  ***      File:  admin_support_priorities.php                             ***
...
*/
  ...
  $t->set_file("main","admin_support_priorities.html");
	...
	$s = new VA_Sorter($settings["admin_templates_dir"], "sorter_img.html", "admin_support_priorities.php");
	...
	$n = new VA_Navigator($settings["admin_templates_dir"], "navigator.html", "admin_support_priorities.php");

	include_once("./admin_header.php");
	include_once("./admin_footer.php");

	// set up variables for navigator
	$db->query("SELECT COUNT(*) FROM " . $table_prefix . "support_priorities");
	$db->next_record();
	...
	$db->query("SELECT * FROM " . $table_prefix . "support_priorities" . $s->order_by);
	if($db->next_record())
	{
